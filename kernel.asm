...
801037df:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037e2:	68 20 2d 11 80       	push   $0x80112d20
  p->pid = nextpid++;
801037e7:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037ed:	e8 5e 0e 00 00       	call   80104650 <release>
...
8010380f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103812:	c7 40 14 ef 58 10 80 	movl   $0x801058ef,0x14(%eax)
  p->context = (struct context*)sp;
...
80103821:	e8 7a 0e 00 00       	call   801046a0 <memset>
...
8010384a:	e8 01 0e 00 00       	call   80104650 <release>
}
...
801038e0 <uproctickets>:
{
801038e0:	f3 0f 1e fb          	endbr32 
801038e4:	55                   	push   %ebp
801038e5:	89 e5                	mov    %esp,%ebp
	tp->tickets=numtickets;
801038e7:	8b 45 08             	mov    0x8(%ebp),%eax
801038ea:	8b 55 0c             	mov    0xc(%ebp),%edx
801038ed:	89 50 7c             	mov    %edx,0x7c(%eax)
}
801038f0:	5d                   	pop    %ebp
801038f1:	c3                   	ret    
...
80103998:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010399b:	e8 f0 0a 00 00       	call   80104490 <pushcli>
  c = mycpu();
801039a0:	e8 5b ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
801039a5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039ab:	e8 30 0b 00 00       	call   801044e0 <popcli>
}
...
801039d7:	e8 d4 34 00 00       	call   80106eb0 <setupkvm>
...
801039f5:	e8 86 31 00 00       	call   80106b80 <inituvm>
...
80103a0a:	e8 91 0c 00 00       	call   801046a0 <memset>
...
80103a63:	68 b0 76 10 80       	push   $0x801076b0
80103a68:	50                   	push   %eax
80103a69:	e8 f2 0d 00 00       	call   80104860 <safestrcpy>
  p->cwd = namei("/");
80103a6e:	c7 04 24 b9 76 10 80 	movl   $0x801076b9,(%esp)
...
80103aa7:	68 97 76 10 80       	push   $0x80107697
...
80103ac9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103acc:	e8 bf 09 00 00       	call   80104490 <pushcli>
  c = mycpu();
80103ad1:	e8 2a fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ad6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103adc:	e8 ff 09 00 00       	call   801044e0 <popcli>
  sz = curproc->sz;
...
80103aef:	e8 7c 2f 00 00       	call   80106a70 <switchuvm>
  return 0;
...
80103b4a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b4d:	e8 3e 09 00 00       	call   80104490 <pushcli>
  c = mycpu();
80103b52:	e8 a9 fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b57:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b5d:	e8 7e 09 00 00       	call   801044e0 <popcli>
  if((np = allocproc()) == 0){
...
80103c96:	e8 f5 08 00 00       	call   80104590 <acquire>
...
80103cb0:	e8 bb 2d 00 00       	call   80106a70 <switchuvm>
...
80103cbb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103cc2:	e8 fc 0b 00 00       	call   801048c3 <swtch>
      switchkvm();
80103cc7:	e8 84 2d 00 00       	call   80106a50 <switchkvm>
      c->proc = 0;
...
80103d13:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d19:	e8 c2 07 00 00       	call   801044e0 <popcli>
  if(!holding(&ptable.lock))
80103d1e:	83 ec 0c             	sub    $0xc,%esp
80103d21:	68 20 2d 11 80       	push   $0x80112d20
80103d26:	e8 15 08 00 00       	call   80104540 <holding>
...
80103d67:	e8 57 0b 00 00       	call   801048c3 <swtch>
  mycpu()->intena = intena;
...
80103dca:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103dcd:	e8 be 06 00 00       	call   80104490 <pushcli>
  c = mycpu();
80103dd2:	e8 29 fb ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103dd7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ddd:	e8 fe 06 00 00       	call   801044e0 <popcli>
  if(curproc == initproc)
...
80103e3a:	e8 51 07 00 00       	call   80104590 <acquire>
...
80103e6f:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80103e74:	75 e4                	jne    80103e5a <exit+0x9a>
      p->parent = initproc;
80103e76:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e7c:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103e81:	eb 10                	jmp    80103e93 <exit+0xd3>
80103e83:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e87:	90                   	nop
80103e88:	83 ea 80             	sub    $0xffffff80,%edx
80103e8b:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
...
80103e9f:	75 e7                	jne    80103e88 <exit+0xc8>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ea1:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
...
80103edd:	68 08 77 10 80       	push   $0x80107708
80103ee2:	e8 a9 c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103ee7:	83 ec 0c             	sub    $0xc,%esp
80103eea:	68 fb 76 10 80       	push   $0x801076fb
...
80103f10:	e8 7b 06 00 00       	call   80104590 <acquire>
  pushcli();
80103f15:	e8 76 05 00 00       	call   80104490 <pushcli>
  c = mycpu();
80103f1a:	e8 e1 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f1f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f25:	e8 b6 05 00 00       	call   801044e0 <popcli>
...
80103f3d:	e8 0e 07 00 00       	call   80104650 <release>
}
...
80103f60:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f63:	e8 28 05 00 00       	call   80104490 <pushcli>
  c = mycpu();
80103f68:	e8 93 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f6d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f73:	e8 68 05 00 00       	call   801044e0 <popcli>
  if(p == 0)
...
80103f94:	e8 f7 05 00 00       	call   80104590 <acquire>
    release(lk);
80103f99:	89 34 24             	mov    %esi,(%esp)
80103f9c:	e8 af 06 00 00       	call   80104650 <release>
  p->chan = chan;
...
80103fbe:	e8 8d 06 00 00       	call   80104650 <release>
    acquire(lk);
...
80103fcf:	5d                   	pop    %ebp
    acquire(lk);
80103fd0:	e9 bb 05 00 00       	jmp    80104590 <acquire>
...
80103ff9:	68 1a 77 10 80       	push   $0x8010771a
80103ffe:	e8 8d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104003:	83 ec 0c             	sub    $0xc,%esp
80104006:	68 14 77 10 80       	push   $0x80107714
...
80104053:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
...
80104069:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010406e:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
...
80104084:	68 20 2d 11 80       	push   $0x80112d20
...
801040aa:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040b1:	e8 7a 2d 00 00       	call   80106e30 <freevm>
        release(&ptable.lock);
...
801040d6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040dd:	e8 6e 05 00 00       	call   80104650 <release>
        return pid;
...
801040fb:	e8 50 05 00 00       	call   80104650 <release>
      return -1;
...
80104123:	e8 68 04 00 00       	call   80104590 <acquire>
...
8010413b:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
...
80104157:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
8010415c:	75 e4                	jne    80104142 <wakeup+0x32>
  wakeup1(chan);
  release(&ptable.lock);
8010415e:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80104165:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104168:	c9                   	leave  
  release(&ptable.lock);
80104169:	e9 e2 04 00 00       	jmp    80104650 <release>
...
80104183:	e8 08 04 00 00       	call   80104590 <acquire>
...
8010419b:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
...
801041c3:	e8 88 04 00 00       	call   80104650 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041e0:	e8 6b 04 00 00       	call   80104650 <release>
}
...
80104244:	74 ea                	je     80104230 <procdump+0x30>
      state = "???";
80104246:	ba 2b 77 10 80       	mov    $0x8010772b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010424b:	83 f8 05             	cmp    $0x5,%eax
8010424e:	77 11                	ja     80104261 <procdump+0x61>
80104250:	8b 14 85 8c 77 10 80 	mov    -0x7fef8874(,%eax,4),%edx
      state = "???";
80104257:	b8 2b 77 10 80       	mov    $0x8010772b,%eax
...
80104266:	68 2f 77 10 80       	push   $0x8010772f
...
8010428d:	e8 9e 01 00 00       	call   80104430 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042a5:	68 81 71 10 80       	push   $0x80107181
...
8010433d:	e8 0e fc ff ff       	call   80103f50 <sleep>
  while (lk->locked) {
...
8010434b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104351:	e8 3a f6 ff ff       	call   80103990 <myproc>
...
80104398:	e8 73 fd ff ff       	call   80104110 <wakeup>
  release(&lk->lk);
...
801043f3:	e8 98 f5 ff ff       	call   80103990 <myproc>
...
801044bf:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
801044c0:	e8 3b f4 ff ff       	call   80103900 <mycpu>
...
801045d4:	e8 27 f3 ff ff       	call   80103900 <mycpu>
...
801048eb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801048ee:	e8 9d f0 ff ff       	call   80103990 <myproc>
...
8010492b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010492e:	e8 5d f0 ff ff       	call   80103990 <myproc>
...
80104989:	e8 02 f0 ff ff       	call   80103990 <myproc>
...
80104997:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
8010499a:	e8 f1 ef ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801049dc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049df:	e8 ac ef ff ff       	call   80103990 <myproc>
...
80104a78:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a7b:	e8 10 ef ff ff       	call   80103990 <myproc>
...
80104a90:	8b 14 85 00 78 10 80 	mov    -0x7fef8800(,%eax,4),%edx
...
80104ca4:	e8 e7 ec ff ff       	call   80103990 <myproc>
...
80104ced:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104cef:	e8 9c ec ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104e37:	78 27                	js     80104e60 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e39:	e8 52 eb ff ff       	call   80103990 <myproc>
...
80105267:	74 23                	je     8010528c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105269:	e8 22 e7 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105449:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010544c:	e8 3f e5 ff ff       	call   80103990 <myproc>
...
8010562b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010562d:	e8 5e e3 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105677:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010567a:	e8 11 e3 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056d0:	f3 0f 1e fb          	endbr32 
  return fork();
801056d4:	e9 67 e4 ff ff       	jmp    80103b40 <fork>
...
801056e7:	83 ec 08             	sub    $0x8,%esp
  exit();
801056ea:	e8 d1 e6 ff ff       	call   80103dc0 <exit>
...
80105700:	f3 0f 1e fb          	endbr32 
  return wait();
80105704:	e9 07 e9 ff ff       	jmp    80104010 <wait>
...
80105732:	e8 39 ea ff ff       	call   80104170 <kill>
...
80105757:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
8010575a:	e8 31 e2 ff ff       	call   80103990 <myproc>
...
8010579a:	e8 21 e3 ff ff       	call   80103ac0 <growproc>
...
801057e4:	68 60 4d 11 80       	push   $0x80114d60
...
80105803:	68 60 4d 11 80       	push   $0x80114d60
80105808:	68 a0 55 11 80       	push   $0x801155a0
8010580d:	e8 3e e7 ff ff       	call   80103f50 <sleep>
  while(ticks - ticks0 < n){
80105812:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
8010581f:	73 2f                	jae    80105850 <sys_sleep+0x90>
    if(myproc()->killed){
80105821:	e8 6a e1 ff ff       	call   80103990 <myproc>
...
80105830:	68 60 4d 11 80       	push   $0x80114d60
...
80105878:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
8010587b:	68 60 4d 11 80       	push   $0x80114d60
80105880:	e8 0b ed ff ff       	call   80104590 <acquire>
  xticks = ticks;
80105885:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
8010588b:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
...
801058bd:	78 11                	js     801058d0 <sys_settickets+0x30>

	//acquire(&ptable.lock);
	//proc->tickets = numtickets;
	myproc()->tickets = numtickets;
801058bf:	e8 cc e0 ff ff       	call   80103990 <myproc>
801058c4:	89 c2                	mov    %eax,%edx
801058c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058c9:	89 42 7c             	mov    %eax,0x7c(%edx)
	//release(&ptable.lock);
...
801059dc:	e8 af df ff ff       	call   80103990 <myproc>
...
801059fc:	e8 6f df ff ff       	call   80103970 <cpuid>
...
80105a15:	e8 76 df ff ff       	call   80103990 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105a3e:	e8 4d df ff ff       	call   80103990 <myproc>
...
80105ac9:	eb a5                	jmp    80105a70 <trap+0xc0>
    if(cpuid() == 0){
80105acb:	e8 a0 de ff ff       	call   80103970 <cpuid>
...
80105ae8:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105aef:	e8 1c e6 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
...
80105b0a:	e8 b1 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b0f:	e8 7c de ff ff       	call   80103990 <myproc>
...
80105b26:	e8 95 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b2b:	e8 60 de ff ff       	call   80103990 <myproc>
...
80105b44:	e8 27 de ff ff       	call   80103970 <cpuid>
...
80105b5b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b5e:	e8 2d de ff ff       	call   80103990 <myproc>
...
80105d8b:	6a 00                	push   $0x0
  jmp alltraps
80105d8d:	e9 45 fb ff ff       	jmp    801058d7 <alltraps>
...
80105d94:	6a 01                	push   $0x1
  jmp alltraps
80105d96:	e9 3c fb ff ff       	jmp    801058d7 <alltraps>
...
80105d9d:	6a 02                	push   $0x2
  jmp alltraps
80105d9f:	e9 33 fb ff ff       	jmp    801058d7 <alltraps>
...
80105da6:	6a 03                	push   $0x3
  jmp alltraps
80105da8:	e9 2a fb ff ff       	jmp    801058d7 <alltraps>
...
80105daf:	6a 04                	push   $0x4
  jmp alltraps
80105db1:	e9 21 fb ff ff       	jmp    801058d7 <alltraps>
...
80105db8:	6a 05                	push   $0x5
  jmp alltraps
80105dba:	e9 18 fb ff ff       	jmp    801058d7 <alltraps>
...
80105dc1:	6a 06                	push   $0x6
  jmp alltraps
80105dc3:	e9 0f fb ff ff       	jmp    801058d7 <alltraps>
...
80105dca:	6a 07                	push   $0x7
  jmp alltraps
80105dcc:	e9 06 fb ff ff       	jmp    801058d7 <alltraps>
...
80105dd1:	6a 08                	push   $0x8
  jmp alltraps
80105dd3:	e9 ff fa ff ff       	jmp    801058d7 <alltraps>
...
80105dda:	6a 09                	push   $0x9
  jmp alltraps
80105ddc:	e9 f6 fa ff ff       	jmp    801058d7 <alltraps>
...
80105de1:	6a 0a                	push   $0xa
  jmp alltraps
80105de3:	e9 ef fa ff ff       	jmp    801058d7 <alltraps>
...
80105de8:	6a 0b                	push   $0xb
  jmp alltraps
80105dea:	e9 e8 fa ff ff       	jmp    801058d7 <alltraps>
...
80105def:	6a 0c                	push   $0xc
  jmp alltraps
80105df1:	e9 e1 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e0f:	6a 10                	push   $0x10
  jmp alltraps
80105e11:	e9 c1 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e16:	6a 11                	push   $0x11
  jmp alltraps
80105e18:	e9 ba fa ff ff       	jmp    801058d7 <alltraps>
...
80105e1f:	6a 12                	push   $0x12
  jmp alltraps
80105e21:	e9 b1 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e28:	6a 13                	push   $0x13
  jmp alltraps
80105e2a:	e9 a8 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e31:	6a 14                	push   $0x14
  jmp alltraps
80105e33:	e9 9f fa ff ff       	jmp    801058d7 <alltraps>
...
80105e3a:	6a 15                	push   $0x15
  jmp alltraps
80105e3c:	e9 96 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e43:	6a 16                	push   $0x16
  jmp alltraps
80105e45:	e9 8d fa ff ff       	jmp    801058d7 <alltraps>
...
80105e4c:	6a 17                	push   $0x17
  jmp alltraps
80105e4e:	e9 84 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e55:	6a 18                	push   $0x18
  jmp alltraps
80105e57:	e9 7b fa ff ff       	jmp    801058d7 <alltraps>
...
80105e5e:	6a 19                	push   $0x19
  jmp alltraps
80105e60:	e9 72 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e67:	6a 1a                	push   $0x1a
  jmp alltraps
80105e69:	e9 69 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e70:	6a 1b                	push   $0x1b
  jmp alltraps
80105e72:	e9 60 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e79:	6a 1c                	push   $0x1c
  jmp alltraps
80105e7b:	e9 57 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e82:	6a 1d                	push   $0x1d
  jmp alltraps
80105e84:	e9 4e fa ff ff       	jmp    801058d7 <alltraps>
...
80105e8b:	6a 1e                	push   $0x1e
  jmp alltraps
80105e8d:	e9 45 fa ff ff       	jmp    801058d7 <alltraps>
...
80105e94:	6a 1f                	push   $0x1f
  jmp alltraps
80105e96:	e9 3c fa ff ff       	jmp    801058d7 <alltraps>
...
80105e9d:	6a 20                	push   $0x20
  jmp alltraps
80105e9f:	e9 33 fa ff ff       	jmp    801058d7 <alltraps>
...
80105ea6:	6a 21                	push   $0x21
  jmp alltraps
80105ea8:	e9 2a fa ff ff       	jmp    801058d7 <alltraps>
...
80105eaf:	6a 22                	push   $0x22
  jmp alltraps
80105eb1:	e9 21 fa ff ff       	jmp    801058d7 <alltraps>
...
80105eb8:	6a 23                	push   $0x23
  jmp alltraps
80105eba:	e9 18 fa ff ff       	jmp    801058d7 <alltraps>
...
80105ec1:	6a 24                	push   $0x24
  jmp alltraps
80105ec3:	e9 0f fa ff ff       	jmp    801058d7 <alltraps>
...
80105eca:	6a 25                	push   $0x25
  jmp alltraps
80105ecc:	e9 06 fa ff ff       	jmp    801058d7 <alltraps>
...
80105ed3:	6a 26                	push   $0x26
  jmp alltraps
80105ed5:	e9 fd f9 ff ff       	jmp    801058d7 <alltraps>
...
80105edc:	6a 27                	push   $0x27
  jmp alltraps
80105ede:	e9 f4 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105ee5:	6a 28                	push   $0x28
  jmp alltraps
80105ee7:	e9 eb f9 ff ff       	jmp    801058d7 <alltraps>
...
80105eee:	6a 29                	push   $0x29
  jmp alltraps
80105ef0:	e9 e2 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105ef7:	6a 2a                	push   $0x2a
  jmp alltraps
80105ef9:	e9 d9 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f00:	6a 2b                	push   $0x2b
  jmp alltraps
80105f02:	e9 d0 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f09:	6a 2c                	push   $0x2c
  jmp alltraps
80105f0b:	e9 c7 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f12:	6a 2d                	push   $0x2d
  jmp alltraps
80105f14:	e9 be f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f1b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f1d:	e9 b5 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f24:	6a 2f                	push   $0x2f
  jmp alltraps
80105f26:	e9 ac f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f2d:	6a 30                	push   $0x30
  jmp alltraps
80105f2f:	e9 a3 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f36:	6a 31                	push   $0x31
  jmp alltraps
80105f38:	e9 9a f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f3f:	6a 32                	push   $0x32
  jmp alltraps
80105f41:	e9 91 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f48:	6a 33                	push   $0x33
  jmp alltraps
80105f4a:	e9 88 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f51:	6a 34                	push   $0x34
  jmp alltraps
80105f53:	e9 7f f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f5a:	6a 35                	push   $0x35
  jmp alltraps
80105f5c:	e9 76 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f63:	6a 36                	push   $0x36
  jmp alltraps
80105f65:	e9 6d f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f6c:	6a 37                	push   $0x37
  jmp alltraps
80105f6e:	e9 64 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f75:	6a 38                	push   $0x38
  jmp alltraps
80105f77:	e9 5b f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f7e:	6a 39                	push   $0x39
  jmp alltraps
80105f80:	e9 52 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f87:	6a 3a                	push   $0x3a
  jmp alltraps
80105f89:	e9 49 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f90:	6a 3b                	push   $0x3b
  jmp alltraps
80105f92:	e9 40 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105f99:	6a 3c                	push   $0x3c
  jmp alltraps
80105f9b:	e9 37 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105fa2:	6a 3d                	push   $0x3d
  jmp alltraps
80105fa4:	e9 2e f9 ff ff       	jmp    801058d7 <alltraps>
...
80105fab:	6a 3e                	push   $0x3e
  jmp alltraps
80105fad:	e9 25 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105fb4:	6a 3f                	push   $0x3f
  jmp alltraps
80105fb6:	e9 1c f9 ff ff       	jmp    801058d7 <alltraps>
...
80105fbd:	6a 40                	push   $0x40
  jmp alltraps
80105fbf:	e9 13 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105fc6:	6a 41                	push   $0x41
  jmp alltraps
80105fc8:	e9 0a f9 ff ff       	jmp    801058d7 <alltraps>
...
80105fcf:	6a 42                	push   $0x42
  jmp alltraps
80105fd1:	e9 01 f9 ff ff       	jmp    801058d7 <alltraps>
...
80105fd8:	6a 43                	push   $0x43
  jmp alltraps
80105fda:	e9 f8 f8 ff ff       	jmp    801058d7 <alltraps>
...
80105fe1:	6a 44                	push   $0x44
  jmp alltraps
80105fe3:	e9 ef f8 ff ff       	jmp    801058d7 <alltraps>
...
80105fea:	6a 45                	push   $0x45
  jmp alltraps
80105fec:	e9 e6 f8 ff ff       	jmp    801058d7 <alltraps>
...
80105ff3:	6a 46                	push   $0x46
  jmp alltraps
80105ff5:	e9 dd f8 ff ff       	jmp    801058d7 <alltraps>
...
80105ffc:	6a 47                	push   $0x47
  jmp alltraps
80105ffe:	e9 d4 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106005:	6a 48                	push   $0x48
  jmp alltraps
80106007:	e9 cb f8 ff ff       	jmp    801058d7 <alltraps>
...
8010600e:	6a 49                	push   $0x49
  jmp alltraps
80106010:	e9 c2 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106017:	6a 4a                	push   $0x4a
  jmp alltraps
80106019:	e9 b9 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106020:	6a 4b                	push   $0x4b
  jmp alltraps
80106022:	e9 b0 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106029:	6a 4c                	push   $0x4c
  jmp alltraps
8010602b:	e9 a7 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106032:	6a 4d                	push   $0x4d
  jmp alltraps
80106034:	e9 9e f8 ff ff       	jmp    801058d7 <alltraps>
...
8010603b:	6a 4e                	push   $0x4e
  jmp alltraps
8010603d:	e9 95 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106044:	6a 4f                	push   $0x4f
  jmp alltraps
80106046:	e9 8c f8 ff ff       	jmp    801058d7 <alltraps>
...
8010604d:	6a 50                	push   $0x50
  jmp alltraps
8010604f:	e9 83 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106056:	6a 51                	push   $0x51
  jmp alltraps
80106058:	e9 7a f8 ff ff       	jmp    801058d7 <alltraps>
...
8010605f:	6a 52                	push   $0x52
  jmp alltraps
80106061:	e9 71 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106068:	6a 53                	push   $0x53
  jmp alltraps
8010606a:	e9 68 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106071:	6a 54                	push   $0x54
  jmp alltraps
80106073:	e9 5f f8 ff ff       	jmp    801058d7 <alltraps>
...
8010607a:	6a 55                	push   $0x55
  jmp alltraps
8010607c:	e9 56 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106083:	6a 56                	push   $0x56
  jmp alltraps
80106085:	e9 4d f8 ff ff       	jmp    801058d7 <alltraps>
...
8010608c:	6a 57                	push   $0x57
  jmp alltraps
8010608e:	e9 44 f8 ff ff       	jmp    801058d7 <alltraps>
...
80106095:	6a 58                	push   $0x58
  jmp alltraps
80106097:	e9 3b f8 ff ff       	jmp    801058d7 <alltraps>
...
8010609e:	6a 59                	push   $0x59
  jmp alltraps
801060a0:	e9 32 f8 ff ff       	jmp    801058d7 <alltraps>
...
801060a7:	6a 5a                	push   $0x5a
  jmp alltraps
801060a9:	e9 29 f8 ff ff       	jmp    801058d7 <alltraps>
...
801060b0:	6a 5b                	push   $0x5b
  jmp alltraps
801060b2:	e9 20 f8 ff ff       	jmp    801058d7 <alltraps>
...
801060b9:	6a 5c                	push   $0x5c
  jmp alltraps
801060bb:	e9 17 f8 ff ff       	jmp    801058d7 <alltraps>
...
801060c2:	6a 5d                	push   $0x5d
  jmp alltraps
801060c4:	e9 0e f8 ff ff       	jmp    801058d7 <alltraps>
...
801060cb:	6a 5e                	push   $0x5e
  jmp alltraps
801060cd:	e9 05 f8 ff ff       	jmp    801058d7 <alltraps>
...
801060d4:	6a 5f                	push   $0x5f
  jmp alltraps
801060d6:	e9 fc f7 ff ff       	jmp    801058d7 <alltraps>
...
801060dd:	6a 60                	push   $0x60
  jmp alltraps
801060df:	e9 f3 f7 ff ff       	jmp    801058d7 <alltraps>
...
801060e6:	6a 61                	push   $0x61
  jmp alltraps
801060e8:	e9 ea f7 ff ff       	jmp    801058d7 <alltraps>
...
801060ef:	6a 62                	push   $0x62
  jmp alltraps
801060f1:	e9 e1 f7 ff ff       	jmp    801058d7 <alltraps>
...
801060f8:	6a 63                	push   $0x63
  jmp alltraps
801060fa:	e9 d8 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106101:	6a 64                	push   $0x64
  jmp alltraps
80106103:	e9 cf f7 ff ff       	jmp    801058d7 <alltraps>
...
8010610a:	6a 65                	push   $0x65
  jmp alltraps
8010610c:	e9 c6 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106113:	6a 66                	push   $0x66
  jmp alltraps
80106115:	e9 bd f7 ff ff       	jmp    801058d7 <alltraps>
...
8010611c:	6a 67                	push   $0x67
  jmp alltraps
8010611e:	e9 b4 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106125:	6a 68                	push   $0x68
  jmp alltraps
80106127:	e9 ab f7 ff ff       	jmp    801058d7 <alltraps>
...
8010612e:	6a 69                	push   $0x69
  jmp alltraps
80106130:	e9 a2 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106137:	6a 6a                	push   $0x6a
  jmp alltraps
80106139:	e9 99 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106140:	6a 6b                	push   $0x6b
  jmp alltraps
80106142:	e9 90 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106149:	6a 6c                	push   $0x6c
  jmp alltraps
8010614b:	e9 87 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106152:	6a 6d                	push   $0x6d
  jmp alltraps
80106154:	e9 7e f7 ff ff       	jmp    801058d7 <alltraps>
...
8010615b:	6a 6e                	push   $0x6e
  jmp alltraps
8010615d:	e9 75 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106164:	6a 6f                	push   $0x6f
  jmp alltraps
80106166:	e9 6c f7 ff ff       	jmp    801058d7 <alltraps>
...
8010616d:	6a 70                	push   $0x70
  jmp alltraps
8010616f:	e9 63 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106176:	6a 71                	push   $0x71
  jmp alltraps
80106178:	e9 5a f7 ff ff       	jmp    801058d7 <alltraps>
...
8010617f:	6a 72                	push   $0x72
  jmp alltraps
80106181:	e9 51 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106188:	6a 73                	push   $0x73
  jmp alltraps
8010618a:	e9 48 f7 ff ff       	jmp    801058d7 <alltraps>
...
80106191:	6a 74                	push   $0x74
  jmp alltraps
80106193:	e9 3f f7 ff ff       	jmp    801058d7 <alltraps>
...
8010619a:	6a 75                	push   $0x75
  jmp alltraps
8010619c:	e9 36 f7 ff ff       	jmp    801058d7 <alltraps>
...
801061a3:	6a 76                	push   $0x76
  jmp alltraps
801061a5:	e9 2d f7 ff ff       	jmp    801058d7 <alltraps>
...
801061ac:	6a 77                	push   $0x77
  jmp alltraps
801061ae:	e9 24 f7 ff ff       	jmp    801058d7 <alltraps>
...
801061b5:	6a 78                	push   $0x78
  jmp alltraps
801061b7:	e9 1b f7 ff ff       	jmp    801058d7 <alltraps>
...
801061be:	6a 79                	push   $0x79
  jmp alltraps
801061c0:	e9 12 f7 ff ff       	jmp    801058d7 <alltraps>
...
801061c7:	6a 7a                	push   $0x7a
  jmp alltraps
801061c9:	e9 09 f7 ff ff       	jmp    801058d7 <alltraps>
...
801061d0:	6a 7b                	push   $0x7b
  jmp alltraps
801061d2:	e9 00 f7 ff ff       	jmp    801058d7 <alltraps>
...
801061d9:	6a 7c                	push   $0x7c
  jmp alltraps
801061db:	e9 f7 f6 ff ff       	jmp    801058d7 <alltraps>
...
801061e2:	6a 7d                	push   $0x7d
  jmp alltraps
801061e4:	e9 ee f6 ff ff       	jmp    801058d7 <alltraps>
...
801061eb:	6a 7e                	push   $0x7e
  jmp alltraps
801061ed:	e9 e5 f6 ff ff       	jmp    801058d7 <alltraps>
...
801061f4:	6a 7f                	push   $0x7f
  jmp alltraps
801061f6:	e9 dc f6 ff ff       	jmp    801058d7 <alltraps>
...
801069c7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069ca:	e8 a1 cf ff ff       	call   80103970 <cpuid>
  pd[0] = size-1;
...
80106aa3:	e8 58 ce ff ff       	call   80103900 <mycpu>
80106aa8:	89 c3                	mov    %eax,%ebx
80106aaa:	e8 51 ce ff ff       	call   80103900 <mycpu>
80106aaf:	89 c7                	mov    %eax,%edi
80106ab1:	e8 4a ce ff ff       	call   80103900 <mycpu>
80106ab6:	83 c7 08             	add    $0x8,%edi
80106ab9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106abc:	e8 3f ce ff ff       	call   80103900 <mycpu>
...
80106b05:	e8 f6 cd ff ff       	call   80103900 <mycpu>
...
80106b23:	e8 d8 cd ff ff       	call   80103900 <mycpu>
80106b28:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b2b:	e8 d0 cd ff ff       	call   80103900 <mycpu>
